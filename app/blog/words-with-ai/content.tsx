...
const defined = (word: string, meaning: string) => (
  <div key={word} className="bg-[var(--surface)] rounded-lg px-4 py-3 border border-[var(--border)]">
    <span className="font-semibold text-[var(--text)]">{word}</span>
    <span className="text-[var(--text-dim)] ml-2">— {meaning}</span>
  </div>
);
    ...
    <div className="bg-[var(--bg)] min-h-screen text-[var(--text)]">
      ...
      <section className="relative pt-32 pb-20 px-4">
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          <Badge className="mb-6 bg-[var(--surface-2)] text-[var(--text)] border-[var(--border)] hover:bg-[var(--surface-2)]">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 text-sm text-[var(--text-dim)] mt-6">
      ...
      <article className="relative z-10 max-w-3xl mx-auto px-4 pb-24 prose prose-lg">
        ...
        <section className="mb-14">
          ...
          <p className="text-[var(--text-dim)] leading-relaxed">
            ...
            <span className="text-[#C81FD4] font-semibold">ai</span> is
        ...
        <section className="mb-14">
          <h2 className="text-2xl font-bold mb-4">
            Words Ending in <span className="text-[#C81FD4]">-ail</span>
          </h2>
          <p className="text-[var(--text-dim)] leading-relaxed mb-6">
        ...
        <section className="mb-14">
          <h2 className="text-2xl font-bold mb-4">
            Words Ending in <span className="text-[#C81FD4]">-ain</span>
          </h2>
          <p className="text-[var(--text-dim)] leading-relaxed mb-6">
        ...
        <section className="mb-14">
          <h2 className="text-2xl font-bold mb-4">
            Words Ending in <span className="text-[#C81FD4]">-air</span>
          </h2>
          <p className="text-[var(--text-dim)] leading-relaxed mb-6">
        ...
        <section className="mb-14">
          <h2 className="text-2xl font-bold mb-4">
            Words with <span className="text-[#C81FD4]">-ait</span> and Related
            Patterns
          </h2>
          <p className="text-[var(--text-dim)] leading-relaxed mb-6">
        ...
        <section className="mb-14">
          ...
          <div className="bg-[var(--surface)] rounded-xl border border-[var(--border)] p-6 not-prose mb-4">
            <h3 className="text-lg font-semibold text-[var(--text)] mb-3">Notable Exceptions</h3>
            <ul className="space-y-2 text-[var(--text-dim)]">
              <li>
                <strong className="text-[var(--text)]">-ain at word end (unstressed):</strong>{" "}
              ...
              <li>
                <strong className="text-[var(--text)]">-air words:</strong> The vowel
                blends into the following &quot;r,&quot; creating the /ɛr/ or /eər/
                sound heard in <em>chair</em> and <em>fair</em>.
              </li>
              <li>
                <strong className="text-[var(--text)]">said &amp; again:</strong> Two of
        ...
        <section className="mb-14">
          ...
          <p className="text-[var(--text-dim)] leading-relaxed mb-4">
            ...
            <span className="text-[#C81FD4] font-semibold">Funlingo</span> is
            built for.
          </p>
          <p className="text-[var(--text-dim)] leading-relaxed mb-4">
        ...
        <section className="mb-8">
          <div className="rounded-2xl p-8 md:p-10 text-center bg-[rgba(200,31,212,0.05)] border border-[#C81FD4]/20">
            <h2 className="text-2xl md:text-3xl font-bold mb-4">
              See These Words Come Alive in Your Favourite&nbsp;Shows
            </h2>
            <p className="text-[var(--text-dim)] mb-8 max-w-xl mx-auto">
            ...
            >
              <Button
                className="text-[var(--text)] text-lg px-8 py-6 rounded-full font-semibold inline-flex items-center gap-2"
                style={{
                  background:
                    "linear-gradient(135deg, #9A1C8E 0%, #C81FD4 100%)",
                }}
              >
