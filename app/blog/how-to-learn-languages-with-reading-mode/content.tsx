    ...
    <div className="flex flex-col min-h-screen bg-[var(--bg)]">
      ...
      <section className="relative w-full py-16 lg:py-24 px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto flex flex-col gap-6 text-center lg:text-left">
          <Badge className="w-fit mx-auto lg:mx-0 bg-[rgba(200,31,212,0.1)] text-[#C81FD4] border-[#C81FD4]/20 px-3 py-1">Learning Guide</Badge>
          <h1 className="font-heading-h1 text-3xl sm:text-4xl lg:text-5xl font-bold text-[var(--text)] leading-tight">Reading Mode: How to Learn Languages While You Watch (Bilingual Captions That Actually Work)</h1>
      ...
      <main className="w-full max-w-3xl mx-auto px-6 pb-24">
        <div className="prose prose-lg max-w-none text-[var(--text-dim)]">
          ...
          <div className="bg-[var(--surface)] border-l-4 border-[#C81FD4] p-6 rounded-r-lg my-8">
            <h3 className="text-[var(--text)] text-lg font-bold mt-0 mb-2">TL;DR</h3>
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-[var(--text)] mt-12 mb-6">Why &quot;watching to learn&quot; often fails -- and how Reading Mode fixes it</h2>
          ...
          <ul className="space-y-3 list-none pl-0 mb-6">
            <li className="flex gap-3"><span className="text-red-400 font-bold">&#10005;</span><span className="text-[var(--text-dim)]">Pausing to look up words interrupts comprehension.</span></li>
            <li className="flex gap-3"><span className="text-red-400 font-bold">&#10005;</span><span className="text-[var(--text-dim)]">Copy-and-paste or typing slow down the flow.</span></li>
            <li className="flex gap-3"><span className="text-red-400 font-bold">&#10005;</span><span className="text-[var(--text-dim)]">Context is lost when you extract single words from a sentence.</span></li>
          </ul>
          <p>Reading Mode solves those problems by keeping audio and reading together.</p>
          <h2 className="text-2xl sm:text-3xl font-bold text-[var(--text)] mt-12 mb-6">How Reading Mode actually works</h2>
          ...
          <ul className="space-y-4 list-disc pl-5 text-[var(--text-dim)]">
            <li><strong className="text-[var(--text)]">Left:</strong> video player with normal playback controls.</li>
            <li><strong className="text-[var(--text)]">Right:</strong> a reading pane with sentence-by-sentence captions.</li>
            <li><strong className="text-[var(--text)]">Active highlight:</strong> the current sentence is emphasized.</li>
            <li><strong className="text-[var(--text)]">Hover micro-help:</strong> hover a word to reveal synonyms and example sentences.</li>
          </ul>
          <h2 className="text-2xl sm:text-3xl font-bold text-[var(--text)] mt-12 mb-8">5 concrete routines to use Reading Mode</h2>
          <div className="space-y-8">
            {[{t:"1. The 15-minute watch + highlight session",d:"Watch 15 minutes of a show you enjoy. Every time you see a new word, hover and tap Save."},{t:"2. The 5-minute drill",d:"Replay a 5-10 second clip with the caption highlighted. Read the sentence aloud three times."},{t:"3. The weekly review",d:"Use your saved words in spaced repetition. Before you watch, quickly review last week's list."},{t:"4. Topic immersion",d:"Pick a theme and watch two short videos. Same domain vocabulary reappears."},{t:"5. Comprehension checks",d:"After a scene, write a one-line summary of what you understood."}].map((s,i)=>(
              <div key={i} className="border border-[var(--border)] rounded-xl p-6 bg-[var(--surface)]">
                <h3 className="text-xl font-bold text-[#C81FD4] mt-0 mb-3">{s.t}</h3>
                <p className="m-0 text-[var(--text-dim)]">{s.d}</p>
              </div>
            ))}
          </div>
          <div className="bg-gradient-to-br from-[#C81FD4]/20 to-transparent p-8 rounded-xl border border-[#C81FD4]/20 mt-16 mb-12">
            <h3 className="text-xl font-bold text-[var(--text)] mb-4 mt-0">What learners told us (real-user micro-case)</h3>
            <blockquote className="border-l-4 border-[#C81FD4] pl-4 italic text-[var(--text)] mb-4">&quot;I started with 10 minutes a day. After two weeks I could follow 30-40% of simple conversations without pausing. The timestamped captions made all the difference.&quot;</blockquote>
            <p className="text-[var(--text-dim)] text-sm text-right">-- Team Funlingo</p>
          </div>
          <h2 className="text-2xl sm:text-3xl font-bold text-[var(--text)] mb-8">Practical FAQs</h2>
          <div className="space-y-8">
            <div><h4 className="text-[var(--text)] font-bold text-lg mb-2">Q: Will Reading Mode work on any video?</h4><p className="text-[var(--text-dim)] m-0">A: It works on most video players that provide subtitles (YouTube, many Vimeo embeds).</p></div>
            <div><h4 className="text-[var(--text)] font-bold text-lg mb-2">Q: Is my data private?</h4><p className="text-[var(--text-dim)] m-0">A: Yes -- captions are rendered locally where possible.</p></div>
            <div><h4 className="text-[var(--text)] font-bold text-lg mb-2">Q: Can I export saved words?</h4><p className="text-[var(--text-dim)] m-0">A: You can export your vocabulary list (CSV/Anki format).</p></div>
          </div>
          <div className="mt-20 text-center py-12 px-6 rounded-2xl bg-[rgba(200,31,212,0.05)] border border-[#C81FD4]/20">
            <h2 className="text-3xl font-bold text-[var(--text)] mb-4">Start using Reading Mode today</h2>
            <p className="text-lg text-[var(--text-dim)] mb-8 max-w-xl mx-auto">Pick one scene, read along, and replay a line 3 times. Small, repeatable actions build real fluency over time.</p>
