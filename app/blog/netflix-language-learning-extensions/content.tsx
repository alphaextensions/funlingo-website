    ...
    <div className="flex flex-col min-h-screen bg-black">
      ...
      <main className="w-full max-w-3xl mx-auto px-6 pb-24">
        <div className="prose prose-invert prose-lg max-w-none text-gray-300">
          ...
          <h2 className="text-3xl font-bold text-white mt-16 mb-6">How to Choose a Language Learning Chrome Extension for Netflix</h2>
          <p className="text-gray-300 mb-4">Choosing the right Chrome extension for Netflix language learning comes down to three questions. First, how much are you willing to pay? Funlingo is the only extension that offers full dual subtitles, word-level translation, pronunciation audio, and vocabulary saving completely free. Language Reactor and Trancy lock their best features behind $6&ndash;10/month subscriptions. Second, which platforms matter to you? If you watch Amazon Prime Video alongside Netflix, Funlingo is the only option that supports all three major platforms. Third, what&apos;s your learning style? If you prefer passive immersion with vocabulary building, Funlingo is ideal. If you want active grammar drills and speaking practice, Trancy&apos;s premium features may justify the cost. For a wider comparison beyond Netflix-specific tools, see our roundup of the <a href="/blog/best-dual-subtitle-extension" className="text-[#C642FC] hover:underline">7 best dual subtitle extensions</a>.</p>
          ...
          <div className="space-y-6">
            {[
              ...
              { q: "Does Netflix have a built-in language learning feature?", a: "No. Netflix doesn't have built-in language learning tools — it only offers standard subtitles in one language at a time. To get dual subtitles, word lookups, vocabulary saving, or pronunciation guides, you need a Chrome extension. Funlingo adds all of these features for free." },
              { q: "Can I use Netflix language learning extensions on my phone or TV?", a: "Netflix language learning extensions are Chrome browser add-ons and only work on desktop computers. They can't be installed on the Netflix mobile app, smart TVs, or tablets. To use dual subtitles on a bigger screen, watch Netflix in Chrome on your laptop and connect it to your TV via HDMI or Chromecast." },
