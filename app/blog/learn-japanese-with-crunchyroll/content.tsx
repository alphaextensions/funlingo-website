    ...
    <div className="flex flex-col min-h-screen bg-[var(--bg)]">
      ...
      <section className="relative w-full py-16 lg:py-24 px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto flex flex-col gap-6 text-center lg:text-left">
          ...
          <h1 className="font-heading-h1 text-3xl sm:text-4xl lg:text-5xl font-bold text-[var(--text)] leading-tight">Learn Japanese on Crunchyroll: Free Dual Subtitles Guide</h1>
      ...
      <main className="w-full max-w-3xl mx-auto px-6 pb-24">
        <div className="prose prose-invert prose-lg max-w-none text-[var(--text-dim)]">
          ...
          <p className="lead text-xl leading-relaxed text-[var(--text)] mb-6">If you already spend hours on <a href="https://www.crunchyroll.com" target="_blank" rel="noopener noreferrer" className="text-[#C81FD4] hover:underline">Crunchyroll</a>, you are sitting on one of the best free Japanese-listening resources in the world — you just are not using it for study yet. This guide shows you how to turn anime episodes into lessons with free Crunchyroll dual subtitles, which titles teach the most usable Japanese, and a light daily routine that actually moves the needle. For the broader, platform-agnostic version of this topic, see our companion guide on how to <a href="/blog/learn-japanese-with-anime" className="text-[#C81FD4] hover:underline">learn Japanese with anime</a>; here we go deep on Crunchyroll specifically.</p>

          <hr className="border-[var(--border)] my-12" />

          <h2 className="text-2xl sm:text-3xl font-bold text-[var(--text)] mb-6">Why Anime Is Great for Learning Japanese</h2>
          <p className="text-[var(--text-dim)] mb-6">Anime gives you something a textbook never can: hours of native Japanese delivered with emotion, facial expression, and on-screen context that make meaning easy to guess. When a character is clearly frustrated, embarrassed, or excited, you absorb not just the words but the register and tone behind them — the difference between casual and polite speech, the little sentence-ending particles, the way real people actually talk. That is comprehensible input at scale, and it is exactly the kind of repeated exposure that builds a listening ear.</p>
          <p className="text-[var(--text-dim)] mb-6">It works best as a supplement, not a replacement. Immersion fills your head with vocabulary and rhythm, but you still need a structured base in grammar and kanji to make sense of what you are hearing. Used together — a little study, a lot of anime — Crunchyroll becomes a steady stream of input that reinforces everything you learn elsewhere.</p>

          <h2 className="text-2xl sm:text-3xl font-bold text-[var(--text)] mb-6">Does Crunchyroll Have Japanese Subtitles?</h2>
          <p className="text-[var(--text-dim)] mb-6">Here is the catch most learners hit: Crunchyroll streams shows in original <strong className="text-[var(--text)]">Japanese audio</strong>, but its subtitle menu is built for <em>translated</em> languages — English, Spanish, Portuguese, and so on. For the vast majority of titles there is no native Japanese caption track in the player, and there is certainly no dual-subtitle mode that shows Japanese and English at the same time. So out of the box you get great audio with English text, which is fine for following the plot but weak for study, because your eyes read the translation and your brain skips the Japanese entirely.</p>
          <p className="text-[var(--text-dim)] mb-6">To actually learn, you need the Japanese on screen next to your own language, and you need to be able to look words up without leaving the episode. That is the gap a free tool fills.</p>

          <h2 className="text-2xl sm:text-3xl font-bold text-[var(--text)] mb-6">How to Set Up Free Dual Subtitles on Crunchyroll</h2>
          <p className="text-[var(--text-dim)] mb-6"><strong className="text-[var(--text)]">Funlingo</strong> is a free Chrome extension that adds Crunchyroll dual subtitles directly to the player. You see the Japanese line and your own language at the same time, and you can click any word in the subtitle for an instant definition, reading, and meaning in context. It works the same way on Netflix, YouTube, and Prime Video too, so one install covers all your watching. Here is how to get it running in under two minutes:</p>
          ...
          <p className="text-[var(--text-dim)] mb-6">Because Funlingo is free by design — not a trial that nudges you toward a subscription — you never hit a paywall mid-episode, and there is no monthly quota to burn through. Grab it from the <a href="/chrome-extension" className="text-[#C81FD4] hover:underline">Chrome extension page</a>. If your watching also happens on Netflix, the same approach is covered in our <a href="/blog/netflix-dual-subtitles" className="text-[#C81FD4] hover:underline">Netflix dual subtitles</a> guide.</p>
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-[var(--text)] mb-6">The Best Anime to Learn Japanese on Crunchyroll</h2>
          <p className="text-[var(--text-dim)] mb-6">The best anime to learn Japanese on Crunchyroll are the ones where people talk like people — everyday vocabulary, modern grammar, and a pace you can follow. Flashy action shows are fun, but they lean on shouted attack names and invented terminology you will rarely use in conversation. The list below is grouped by level so you can start where you actually are and climb.</p>

          <h3 className="text-xl sm:text-2xl font-bold text-[var(--text)] mb-4">Beginner: start with slice-of-life</h3>
          <p className="text-[var(--text-dim)] mb-6">If you want the best slice of life anime to learn Japanese, this is your tier. Slice-of-life and school comedies are gold for beginners because the Japanese is slow, clear, and grounded in daily situations — greetings, food, school, family, weather. Look for gentle, low-stakes shows about ordinary life and cozy hobbies. The dialogue repeats the same high-frequency words constantly, which is exactly what a beginner needs to lock in a core vocabulary.</p>

          <h3 className="text-xl sm:text-2xl font-bold text-[var(--text)] mb-4">Intermediate: romance and everyday drama</h3>
          <p className="text-[var(--text-dim)] mb-6">Once basic conversations feel comfortable, move to romance, school drama, and workplace stories. The sentences get longer and the emotional range wider, so you meet more polite and casual register shifts, more idioms, and faster back-and-forth — without jumping into specialist jargon. This tier is where your listening speed really grows.</p>

          <h3 className="text-xl sm:text-2xl font-bold text-[var(--text)] mb-4">Advanced: action, fantasy, and dense scripts</h3>
          <p className="text-[var(--text-dim)] mb-6">When you can follow intermediate shows mostly by ear, action, fantasy, mystery, and sci-fi open up. These carry heavier vocabulary, invented terms, and rapid dialogue, so save them for when guessing from context is comfortable. Pick stories you love enough to rewatch — repetition is what converts a hard show into an easy one.</p>
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-[var(--text)] mb-6">A Simple Daily Anime Routine</h2>
          <p className="text-[var(--text-dim)] mb-6">You do not need hours a day — you need consistency. A single episode handled deliberately beats a marathon you forget. Here is a routine that fits in roughly 30 minutes:</p>
          ...
          <p className="text-[var(--text-dim)] mb-6">Most learners who quit anime immersion make the same few errors. Sidestep these and you will stay on track:</p>
          <ul className="list-disc pl-6 text-[var(--text-dim)] mb-6 space-y-2">
            <li><strong className="text-[var(--text)]">Reading only the English line.</strong> If your eyes never touch the Japanese, you are watching, not studying. Dual subtitles only help if you actually read the Japanese first and use the English to confirm.</li>
            <li><strong className="text-[var(--text)]">Starting too hard.</strong> Jumping into a dense action series as a beginner is demoralizing. Begin with slice-of-life and earn the harder shows.</li>
            <li><strong className="text-[var(--text)]">Trying to understand every word.</strong> Pausing on every line kills momentum. Let some things wash over you and look up only what repeats.</li>
            <li><strong className="text-[var(--text)]">Skipping grammar entirely.</strong> Anime is input, not a syllabus. Without a grammar base, the sentences stay a blur no matter how much you watch.</li>
            <li><strong className="text-[var(--text)]">Copying anime speech wholesale.</strong> A lot of anime dialogue is rough, dramatic, or gendered in ways that sound odd in real life. Enjoy it, but verify register before you use a phrase yourself.</li>
          </ul>

          <div className="bg-[var(--surface)] p-6 rounded-xl border border-[var(--border)] mb-8">
            <div className="flex items-center gap-2 mb-3"><Tv className="w-5 h-5 text-[#C81FD4]" /><span className="font-semibold text-[var(--text)]">One install, every platform</span></div>
            <p className="text-[var(--text-dim)]">Funlingo is not Crunchyroll-only. The same dual subtitles and click-to-translate work on Netflix, YouTube, and Prime Video, so whatever you watch becomes Japanese practice. Start on Crunchyroll, then point it at anything else you already enjoy — see the full picture on the <a href="/chrome-extension" className="text-[#C81FD4] hover:underline">extension page</a>.</p>
          </div>
