    ...
    <div className="flex flex-col min-h-screen bg-black">
      ...
      <main className="w-full max-w-3xl mx-auto px-6 pb-24">
        <div className="prose prose-invert prose-lg max-w-none text-gray-300">
          ...
          <p className="lead text-xl leading-relaxed text-gray-200 mb-6">If you searched for &quot;immersive translate free,&quot; you probably want a straight answer: how much of <a href="https://immersivetranslate.com" target="_blank" rel="noopener noreferrer" className="text-[#C642FC] hover:underline">Immersive Translate</a> can you actually use without paying, and is the Pro plan worth it? The short version is that Immersive Translate has one of the more generous free tiers in the translation-tool space, but its premium AI engines and higher quotas sit behind a subscription. This guide breaks down exactly what is free versus paid, how to squeeze the most out of the free tier honestly, and where a genuinely free alternative makes more sense — especially for translating video subtitles.</p>
          ...
          <p className="text-gray-300 mb-6">The free tier also lets you choose among several machine translation engines, including <a href="https://translate.google.com" target="_blank" rel="noopener noreferrer" className="text-[#C642FC] hover:underline">Google Translate</a>, <a href="https://www.microsoft.com/en-us/translator/" target="_blank" rel="noopener noreferrer" className="text-[#C642FC] hover:underline">Microsoft Translator</a>, and <a href="https://www.deepl.com" target="_blank" rel="noopener noreferrer" className="text-[#C642FC] hover:underline">DeepL</a>&apos;s free quota. For casual reading of foreign articles, documentation, or forum threads, the free version is often all you ever need. Where the free plan draws the line is on volume and on premium AI: large language model engines and high-throughput document or subtitle translation are metered, and once you hit the monthly cap you either wait, switch to a free engine, or upgrade.</p>
