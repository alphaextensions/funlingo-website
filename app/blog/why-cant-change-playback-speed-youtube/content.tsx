    ...
    <div className="flex flex-col min-h-screen bg-[var(--bg)]">
      ...
      <main className="w-full max-w-3xl mx-auto px-6 pb-24">
        <div className="prose prose-lg max-w-none text-[var(--text-dim)]">
          ...
          {/* Quick Overview */}
          <div className="bg-[var(--surface)] border border-[var(--border)] rounded-xl p-6 my-8 not-prose">
            <h3 className="text-[var(--text)] font-semibold text-lg mb-4 flex items-center gap-2">
              <Zap className="w-5 h-5 text-[#C81FD4]" /> Quick Overview of Causes
            </h3>
            <div className="space-y-2 text-[var(--text-dim)] text-sm">
              <div className="flex items-center gap-3">
                <span className="w-6 h-6 rounded-full bg-[#C81FD4]/20 text-[#C81FD4] flex items-center justify-center text-xs font-bold flex-shrink-0">1</span>
                <span>Outdated browser or YouTube app</span>
              </div>
              <div className="flex items-center gap-3">
                <span className="w-6 h-6 rounded-full bg-[#C81FD4]/20 text-[#C81FD4] flex items-center justify-center text-xs font-bold flex-shrink-0">2</span>
                <span>Browser extensions causing conflicts</span>
              </div>
              <div className="flex items-center gap-3">
                <span className="w-6 h-6 rounded-full bg-[#C81FD4]/20 text-[#C81FD4] flex items-center justify-center text-xs font-bold flex-shrink-0">3</span>
                <span>Embedded videos with restricted controls</span>
              </div>
              <div className="flex items-center gap-3">
                <span className="w-6 h-6 rounded-full bg-[#C81FD4]/20 text-[#C81FD4] flex items-center justify-center text-xs font-bold flex-shrink-0">4</span>
                <span>Live streams and premieres (speed disabled by design)</span>
              </div>
              <div className="flex items-center gap-3">
                <span className="w-6 h-6 rounded-full bg-[#C81FD4]/20 text-[#C81FD4] flex items-center justify-center text-xs font-bold flex-shrink-0">5</span>
                <span>Mobile app glitches</span>
              </div>
              <div className="flex items-center gap-3">
                <span className="w-6 h-6 rounded-full bg-[#C81FD4]/20 text-[#C81FD4] flex items-center justify-center text-xs font-bold flex-shrink-0">6</span>
          ...
          <div className="bg-[var(--surface)] border border-[var(--border)] rounded-xl p-6 my-6 not-prose">
            <h3 className="text-[var(--text)] font-semibold mb-4 flex items-center gap-2">
              <RefreshCw className="w-5 h-5 text-[#C81FD4]" /> How to Fix
            </h3>
            <div className="space-y-3 text-[var(--text-dim)] text-sm">
              <div className="flex items-start gap-2">
                <Check className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                <span>
                  <strong className="text-[var(--text)]">Desktop:</strong> Update your
                  browser to the latest version. In Chrome, go to{" "}
                  <code className="bg-[var(--surface-2)] px-1.5 py-0.5 rounded text-xs">chrome://settings/help</code>{" "}
              ...
              <div className="flex items-start gap-2">
                <Check className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                <span>
                  <strong className="text-[var(--text)]">Mobile:</strong> Open the App
              ...
              <div className="flex items-start gap-2">
                <Check className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                <span>
                  <strong className="text-[var(--text)]">Smart TV / Console:</strong>{" "}
          ...
          <div className="bg-[var(--surface)] border border-[var(--border)] rounded-xl p-6 my-6 not-prose">
            <h3 className="text-[var(--text)] font-semibold mb-4 flex items-center gap-2">
              <Settings className="w-5 h-5 text-[#C81FD4]" /> How to Fix
            </h3>
            <div className="space-y-3 text-[var(--text-dim)] text-sm">
              <div className="flex items-start gap-2">
                <Check className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                <span>
                  Open YouTube in an <strong className="text-[var(--text)]">incognito / private window</strong>{" "}
              ...
              <div className="flex items-start gap-2">
                ...
                <span>
                  ...
                  <code className="bg-[var(--surface-2)] px-1.5 py-0.5 rounded text-xs">chrome://extensions</code>)
          ...
          <div className="bg-[var(--surface)] border border-[var(--border)] rounded-xl p-6 my-6 not-prose">
            <h3 className="text-[var(--text)] font-semibold mb-4 flex items-center gap-2">
              <Monitor className="w-5 h-5 text-[#C81FD4]" /> How to Fix
            </h3>
            <div className="space-y-3 text-[var(--text-dim)] text-sm">
              <div className="flex items-start gap-2">
                <Check className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                <span>
                  Click the <strong className="text-[var(--text)]">YouTube logo</strong>{" "}
              ...
              <div className="flex items-start gap-2">
                ...
                <span>
                  ...
                  <strong className="text-[var(--text)]">&quot;Copy video URL&quot;</strong>, and
          ...
          <div className="grid sm:grid-cols-2 gap-4 my-6 not-prose">
            <div className="bg-[var(--surface)] border border-[var(--border)] rounded-xl p-5">
              <Smartphone className="w-6 h-6 text-[#C81FD4] mb-3" />
              <h4 className="text-[var(--text)] font-semibold mb-2">Android Fixes</h4>
            ...
            <div className="bg-[var(--surface)] border border-[var(--border)] rounded-xl p-5">
              <Smartphone className="w-6 h-6 text-[#C81FD4] mb-3" />
              <h4 className="text-[var(--text)] font-semibold mb-2">iOS Fixes</h4>
              <ul className="space-y-2 text-[var(--text-dim)] text-sm">
                <li className="flex items-start gap-2">
                  <Check className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
          ...
          <div className="bg-[var(--surface)] border border-[var(--border)] rounded-xl p-6 my-6 not-prose">
            <h3 className="text-[var(--text)] font-semibold mb-4 flex items-center gap-2">
              <RefreshCw className="w-5 h-5 text-[#C81FD4]" /> How to Clear Cache in Chrome
            </h3>
            <ol className="space-y-3 text-[var(--text-dim)] text-sm">
              <li className="flex gap-3">
                <span className="flex-shrink-0 w-6 h-6 rounded-full bg-[#C81FD4]/20 text-[#C81FD4] flex items-center justify-center text-xs font-bold">
                  1
                </span>
                <span>
                  Press <code className="bg-[var(--surface-2)] px-1.5 py-0.5 rounded text-xs">Ctrl+Shift+Delete</code>{" "}
                  (or <code className="bg-[var(--surface-2)] px-1.5 py-0.5 rounded text-xs">Cmd+Shift+Delete</code> on Mac).
                </span>
              </li>
              <li className="flex gap-3">
                <span className="flex-shrink-0 w-6 h-6 rounded-full bg-[#C81FD4]/20 text-[#C81FD4] flex items-center justify-center text-xs font-bold">
                ...
                <span>
                  Set the time range to <strong className="text-[var(--text)]">&quot;All time&quot;</strong>.
                </span>
              </li>
              <li className="flex gap-3">
                <span className="flex-shrink-0 w-6 h-6 rounded-full bg-[#C81FD4]/20 text-[#C81FD4] flex items-center justify-center text-xs font-bold">
                ...
                <span>
                  Check <strong className="text-[var(--text)]">&quot;Cached images and files&quot;</strong>{" "}
                  and <strong className="text-[var(--text)]">&quot;Cookies and other site data&quot;</strong>.
                </span>
              </li>
              <li className="flex gap-3">
                <span className="flex-shrink-0 w-6 h-6 rounded-full bg-[#C81FD4]/20 text-[#C81FD4] flex items-center justify-center text-xs font-bold">
                ...
                <span>
                  Click <strong className="text-[var(--text)]">&quot;Clear data&quot;</strong>,
          ...
          <p>
            ...
            <code className="bg-[var(--surface-2)] px-1.5 py-0.5 rounded text-xs">chrome://settings/content/all</code>{" "}
            ...
            <table className="w-full text-sm text-[var(--text-dim)] border border-[var(--border)] rounded-xl overflow-hidden">
              <thead>
                <tr className="bg-[var(--surface)]">
                  ...
                  <th className="text-center p-3 text-[var(--text)] font-semibold">Desktop</th>
                  <th className="text-center p-3 text-[var(--text)] font-semibold">Mobile App</th>
                </tr>
              </thead>
              <tbody>
          ...
          <div className="bg-[var(--surface)] border border-[var(--border)] rounded-xl p-5 my-6 not-prose">
            <div className="flex items-start gap-3">
              <Lightbulb className="w-6 h-6 text-[#C81FD4] flex-shrink-0 mt-0.5" />
              <div>
                <p className="text-[var(--text)] font-semibold text-sm mb-1">Pro Tip: Keyboard Shortcuts</p>
                <p className="text-[var(--text-dim)] text-sm">
                  On desktop, you can quickly change playback speed without
                  opening the settings menu. Press{" "}
                  <code className="bg-[var(--surface-2)] px-1.5 py-0.5 rounded text-xs">Shift + &gt;</code>{" "}
                  to speed up and{" "}
                  <code className="bg-[var(--surface-2)] px-1.5 py-0.5 rounded text-xs">Shift + &lt;</code>{" "}
          ...
          <div className="space-y-3 my-6 not-prose">
            <div className="flex items-start gap-3 bg-[var(--surface)] border border-[var(--border)] rounded-xl p-4">
              ...
              <div>
                <p className="text-[var(--text)] font-medium text-sm">Start at 0.75x for new content</p>
                <p className="text-[var(--text-dim)] text-sm">
            ...
            <div className="flex items-start gap-3 bg-[var(--surface)] border border-[var(--border)] rounded-xl p-4">
              <Check className="w-5 h-5 text-[#C81FD4] mt-0.5 flex-shrink-0" />
              <div>
                <p className="text-[var(--text)] font-medium text-sm">Rewatch at normal speed</p>
                <p className="text-[var(--text-dim)] text-sm">
            ...
            <div className="flex items-start gap-3 bg-[var(--surface)] border border-[var(--border)] rounded-xl p-4">
              <Check className="w-5 h-5 text-[#C81FD4] mt-0.5 flex-shrink-0" />
              <div>
                <p className="text-[var(--text)] font-medium text-sm">Challenge yourself at 1.25x–1.5x</p>
                <p className="text-[var(--text-dim)] text-sm">
            ...
            <div className="flex items-start gap-3 bg-[var(--surface)] border border-[var(--border)] rounded-xl p-4">
              <Check className="w-5 h-5 text-[#C81FD4] mt-0.5 flex-shrink-0" />
              <div>
                <p className="text-[var(--text)] font-medium text-sm">Pair speed control with dual subtitles</p>
                <p className="text-[var(--text-dim)] text-sm">
          ...
          <div className="space-y-2 my-6 not-prose text-[var(--text-dim)] text-sm">
            <div className="flex items-center gap-3">
              <div className="w-5 h-5 rounded border border-[var(--border)] flex items-center justify-center">
                <Check className="w-3 h-3 text-[#C81FD4]" />
              </div>
          ...
          <ul>
            ...
            <li>
              <a href="/blog/download-subtitles-from-youtube" className="text-[#C81FD4] no-underline hover:underline">
