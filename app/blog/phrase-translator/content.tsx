  ...
  return (
    <div className="flex flex-col min-h-screen bg-[var(--bg)]">
      ...
      <section className="relative w-full py-16 lg:py-24 px-6 overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-teal-900/40 via-[var(--bg)] to-[var(--bg)] z-0 pointer-events-none" />
        <div className="relative z-10 max-w-4xl mx-auto flex flex-col gap-6 text-center lg:text-left">
          ...
          <h1 className="font-heading-h1 text-3xl sm:text-4xl lg:text-5xl font-bold text-[var(--text)] leading-tight">Phrase Translator — Best Tools for Idioms &amp; Expressions (2026)</h1>
      ...
      <main className="w-full max-w-3xl mx-auto px-6 pb-24">
        <div className="prose prose-lg max-w-none text-[var(--text-dim)]">
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-[var(--text)] mb-6">Why Regular Translators Fail at Phrases and Idioms</h2>
          ...
          <p className="text-[var(--text-dim)] mb-6">Consider these examples of what happens when you run idioms through a literal translator:</p>
              ...
              <table className="w-full text-sm text-[var(--text-dim)]">
                <thead>
                  <tr className="border-b border-[var(--border)]">
                    <th className="text-left py-2 pr-4 text-[var(--text)]">Original Phrase</th>
                    <th className="text-left py-2 pr-4 text-[var(--text)]">Literal Translation</th>
                    <th className="text-left py-2 text-[var(--text)]">Correct Meaning</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="border-b border-[var(--border)]"><td className="py-2 pr-4">&quot;Il pleut des cordes&quot; (French)</td><td className="py-2 pr-4 text-red-400">It&apos;s raining ropes</td><td className="py-2 text-green-400">It&apos;s raining heavily</td></tr>
                  <tr className="border-b border-[var(--border)]"><td className="py-2 pr-4">&quot;Tomarse el pelo&quot; (Spanish)</td><td className="py-2 pr-4 text-red-400">To take the hair</td><td className="py-2 text-green-400">To pull someone&apos;s leg / joke around</td></tr>
                  <tr className="border-b border-[var(--border)]"><td className="py-2 pr-4">&quot;Da liegt der Hund begraben&quot; (German)</td><td className="py-2 pr-4 text-red-400">That&apos;s where the dog is buried</td><td className="py-2 text-green-400">That&apos;s the crux of the matter</td></tr>
                  <tr className="border-b border-[var(--border)]"><td className="py-2 pr-4">&quot;Avere le mani in pasta&quot; (Italian)</td><td className="py-2 pr-4 text-red-400">To have hands in dough</td><td className="py-2 text-green-400">To have a finger in every pie</td></tr>
                  <tr className="border-b border-[var(--border)]"><td className="py-2 pr-4">&quot;Neko no te mo karitai&quot; (Japanese)</td><td className="py-2 pr-4 text-red-400">Want to borrow a cat&apos;s paw</td><td className="py-2 text-green-400">So busy you&apos;d accept any help</td></tr>
          ...
          <p className="text-[var(--text-dim)] mb-6">This is why phrase-aware translation tools exist. They treat multi-word expressions as single units of meaning and match them against databases of equivalent expressions in the target language, or use large language models that understand figurative language.</p>

          <hr className="border-[var(--border)] my-12" />

          <h2 className="text-2xl sm:text-3xl font-bold text-[var(--text)] mb-6">The 8 Best Phrase Translators for 2026</h2>
          <p className="text-[var(--text-dim)] mb-6">Not every translator handles phrases equally. Here are eight tools that do a significantly better job at translating idioms, expressions, and culturally specific phrases than a standard word-by-word engine.</p>

          {/* 1. ChatGPT */}
          <div className="bg-[var(--surface)] p-6 rounded-xl border border-[var(--border)] mb-6">
            <h3 className="text-xl font-semibold text-[var(--text)] mb-3">1. <a href="https://chatgpt.com" target="_blank" rel="noopener noreferrer" className="text-[var(--text)] hover:text-[#C81FD4] transition-colors">ChatGPT</a> (OpenAI)</h3>
            <p className="text-[var(--text-dim)] mb-3">ChatGPT is arguably the best phrase translator available today, not because it was built for translation, but because large language models fundamentally understand meaning in context. Ask ChatGPT to translate &quot;Il pleut des cordes&quot; and it will tell you it means &quot;It&apos;s raining cats and dogs&quot; &mdash; not &quot;It&apos;s raining ropes.&quot; You can also ask it to explain the origin of the idiom, provide equivalent expressions in other languages, and suggest how to use the phrase naturally in conversation. The ability to have a back-and-forth dialogue about a phrase makes it unmatched for deep understanding.</p>
            <div className="flex flex-wrap gap-4 text-sm text-[var(--text-dim)] mb-3">
              <span><strong className="text-[var(--text)]">Best for:</strong> Deep idiom explanation, multi-language comparisons</span>
              <span><strong className="text-[var(--text)]">Pricing:</strong> Free tier; Plus $20/mo</span>
            </div>
          ...
          {/* 3. DeepL */}
          <div className="bg-[var(--surface)] p-6 rounded-xl border border-[var(--border)] mb-6">
            <h3 className="text-xl font-semibold text-[var(--text)] mb-3">3. <a href="https://www.deepl.com" target="_blank" rel="noopener noreferrer" className="text-[var(--text)] hover:text-[#C81FD4] transition-colors">DeepL</a></h3>
            <p className="text-[var(--text-dim)] mb-3">DeepL does not explain idioms like an LLM does, but it translates many of them correctly &mdash; especially for European language pairs. Where Google Translate might output a literal rendering of &quot;tomarse el pelo,&quot; DeepL often produces the correct idiomatic equivalent in English. Its strength is that phrase-level understanding is baked into its neural network from training on high-quality bilingual corpora. For common idioms in French, German, Spanish, Dutch, and Italian, DeepL gets it right more often than any other dedicated translation engine.</p>
            <div className="flex flex-wrap gap-4 text-sm text-[var(--text-dim)] mb-3">
              <span><strong className="text-[var(--text)]">Best for:</strong> European idioms, fast and accurate translation</span>
              <span><strong className="text-[var(--text)]">Pricing:</strong> Free tier; Pro from $8.74/mo</span>
            </div>
            <div className="flex flex-col gap-2 text-sm">
          ...
          {/* 4. Google Translate */}
          <div className="bg-[var(--surface)] p-6 rounded-xl border border-[var(--border)] mb-6">
            <h3 className="text-xl font-semibold text-[var(--text)] mb-3">4. Google Translate</h3>
            ...
            <div className="flex flex-wrap gap-4 text-sm text-[var(--text-dim)] mb-3">
              <span><strong className="text-[var(--text)]">Best for:</strong> Common idioms across 133+ languages</span>
              <span><strong className="text-[var(--text)]">Pricing:</strong> Free</span>
            </div>
            <div className="flex flex-col gap-2 text-sm">
          ...
          {/* 6. Linguee */}
          <div className="bg-[var(--surface)] p-6 rounded-xl border border-[var(--border)] mb-6">
            <h3 className="text-xl font-semibold text-[var(--text)] mb-3">6. <a href="https://www.linguee.com" target="_blank" rel="noopener noreferrer" className="text-[var(--text)] hover:text-[#C81FD4] transition-colors">Linguee</a></h3>
            <p className="text-[var(--text-dim)] mb-3">Built by the same team behind DeepL, Linguee is a bilingual concordance search engine. It works similarly to Reverso Context: you enter a phrase and it shows you how that phrase has been translated in real-world documents. Linguee draws from a curated corpus of professional translations including EU documents, patent filings, and published articles. This makes it particularly reliable for formal and technical phrases. The dictionary entries that accompany search results also provide definitions, pronunciation, and usage notes.</p>
            <div className="flex flex-wrap gap-4 text-sm text-[var(--text-dim)] mb-3">
              <span><strong className="text-[var(--text)]">Best for:</strong> Formal/technical phrases, professional translation</span>
              <span><strong className="text-[var(--text)]">Pricing:</strong> Free</span>
            </div>
            <div className="flex flex-col gap-2 text-sm">
          ...
          <div className="bg-[var(--surface)] p-6 rounded-xl border border-[var(--border)] mb-6">
            <h3 className="text-xl font-semibold text-[var(--text)] mb-3">8. Farlex Idioms Dictionary (via The Free Dictionary)</h3>
            <p className="text-[var(--text-dim)] mb-3">The Farlex Idioms Dictionary, hosted on The Free Dictionary, is one of the most comprehensive English idiom databases available. It contains over 60,000 idiom entries with definitions, usage examples, and etymology. While it does not translate between languages, it is the best tool for understanding English idioms when you encounter them. For language learners whose target language is English, it fills a critical gap: when you hear an idiom in a show or conversation and need to quickly understand what it means, Farlex provides clear, example-rich definitions.</p>
            <div className="flex flex-wrap gap-4 text-sm text-[var(--text-dim)] mb-3">
              <span><strong className="text-[var(--text)]">Best for:</strong> Understanding English idioms and expressions</span>
              <span><strong className="text-[var(--text)]">Pricing:</strong> Free</span>
            </div>
            <div className="flex flex-col gap-2 text-sm">
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-[var(--text)] mb-6">20 Common Idioms Across Languages with Correct Translations</h2>
          <p className="text-[var(--text-dim)] mb-6">Every language has its own set of idioms that sound bizarre when translated literally. Here are 20 widely used expressions from different languages, with their actual meaning and an equivalent English phrase where one exists.</p>

          <div className="bg-[var(--surface)] p-6 rounded-xl border border-[var(--border)] mb-6">
            <div className="flex items-center gap-2 mb-4"><Globe className="w-5 h-5 text-[#C81FD4]" /><span className="font-semibold text-[var(--text)]">French Idioms</span></div>
            <div className="flex flex-col gap-3 text-sm text-[var(--text-dim)]">
              <div><strong className="text-[var(--text)]">1. &quot;Avoir le cafard&quot;</strong> &mdash; Literal: To have the cockroach. Meaning: To feel depressed or down.</div>
              <div><strong className="text-[var(--text)]">2. &quot;Poser un lapin&quot;</strong> &mdash; Literal: To put down a rabbit. Meaning: To stand someone up (miss a date or meeting).</div>
              <div><strong className="text-[var(--text)]">3. &quot;Couper les cheveux en quatre&quot;</strong> &mdash; Literal: To cut hairs into four. Meaning: To split hairs / overthink details.</div>
              <div><strong className="text-[var(--text)]">4. &quot;Avoir la moutarde qui monte au nez&quot;</strong> &mdash; Literal: To have the mustard rising to one&apos;s nose. Meaning: To be getting angry.</div>
            </div>
          </div>

          <div className="bg-[var(--surface)] p-6 rounded-xl border border-[var(--border)] mb-6">
            <div className="flex items-center gap-2 mb-4"><Globe className="w-5 h-5 text-[#C81FD4]" /><span className="font-semibold text-[var(--text)]">Spanish Idioms</span></div>
            <div className="flex flex-col gap-3 text-sm text-[var(--text-dim)]">
              <div><strong className="text-[var(--text)]">5. &quot;Estar en las nubes&quot;</strong> &mdash; Literal: To be in the clouds. Meaning: To daydream or be absent-minded.</div>
              <div><strong className="text-[var(--text)]">6. &quot;No tener pelos en la lengua&quot;</strong> &mdash; Literal: To have no hairs on the tongue. Meaning: To speak bluntly, not mince words.</div>
              <div><strong className="text-[var(--text)]">7. &quot;Ser pan comido&quot;</strong> &mdash; Literal: To be eaten bread. Meaning: To be a piece of cake / very easy.</div>
              <div><strong className="text-[var(--text)]">8. &quot;Meter la pata&quot;</strong> &mdash; Literal: To put in the paw. Meaning: To put your foot in it / make a blunder.</div>
            </div>
          </div>

          <div className="bg-[var(--surface)] p-6 rounded-xl border border-[var(--border)] mb-6">
            <div className="flex items-center gap-2 mb-4"><Globe className="w-5 h-5 text-[#C81FD4]" /><span className="font-semibold text-[var(--text)]">German Idioms</span></div>
            <div className="flex flex-col gap-3 text-sm text-[var(--text-dim)]">
              <div><strong className="text-[var(--text)]">9. &quot;Ich verstehe nur Bahnhof&quot;</strong> &mdash; Literal: I only understand train station. Meaning: I do not understand anything / it&apos;s all Greek to me.</div>
              <div><strong className="text-[var(--text)]">10. &quot;Die Daumen dr&uuml;cken&quot;</strong> &mdash; Literal: To press the thumbs. Meaning: To cross one&apos;s fingers / wish someone luck.</div>
              <div><strong className="text-[var(--text)]">11. &quot;Seinen Senf dazugeben&quot;</strong> &mdash; Literal: To add one&apos;s mustard to it. Meaning: To put in your two cents.</div>
              <div><strong className="text-[var(--text)]">12. &quot;Schwein haben&quot;</strong> &mdash; Literal: To have a pig. Meaning: To be lucky.</div>
            </div>
          </div>

          <div className="bg-[var(--surface)] p-6 rounded-xl border border-[var(--border)] mb-6">
            <div className="flex items-center gap-2 mb-4"><Globe className="w-5 h-5 text-[#C81FD4]" /><span className="font-semibold text-[var(--text)]">Japanese Idioms</span></div>
            <div className="flex flex-col gap-3 text-sm text-[var(--text-dim)]">
              <div><strong className="text-[var(--text)]">13. &quot;Saru mo ki kara ochiru&quot;</strong> &mdash; Literal: Even monkeys fall from trees. Meaning: Everyone makes mistakes, even experts.</div>
              <div><strong className="text-[var(--text)]">14. &quot;Hana yori dango&quot;</strong> &mdash; Literal: Dumplings over flowers. Meaning: Substance over style / practicality over beauty.</div>
              <div><strong className="text-[var(--text)]">15. &quot;Nana korobi ya oki&quot;</strong> &mdash; Literal: Fall seven times, stand up eight. Meaning: Perseverance through failure.</div>
              <div><strong className="text-[var(--text)]">16. &quot;Kuchi ga karui&quot;</strong> &mdash; Literal: Light mouth. Meaning: Someone who cannot keep a secret.</div>
            </div>
          </div>

          <div className="bg-[var(--surface)] p-6 rounded-xl border border-[var(--border)] mb-6">
            <div className="flex items-center gap-2 mb-4"><Globe className="w-5 h-5 text-[#C81FD4]" /><span className="font-semibold text-[var(--text)]">Korean, Italian, Portuguese &amp; Turkish Idioms</span></div>
            <div className="flex flex-col gap-3 text-sm text-[var(--text-dim)]">
              <div><strong className="text-[var(--text)]">17. &quot;Nun-i nopda&quot; (Korean)</strong> &mdash; Literal: Eyes are high. Meaning: To have high standards (especially in dating).</div>
              <div><strong className="text-[var(--text)]">18. &quot;In bocca al lupo&quot; (Italian)</strong> &mdash; Literal: In the mouth of the wolf. Meaning: Break a leg / good luck.</div>
              <div><strong className="text-[var(--text)]">19. &quot;&Aacute;gua mole em pedra dura&quot; (Portuguese)</strong> &mdash; Literal: Soft water on hard stone. Meaning: Persistence pays off (dripping water wears the stone).</div>
              <div><strong className="text-[var(--text)]">20. &quot;Bal&inodot;k kavala&quot; (Turkish)</strong> &mdash; Literal: Fish on the shore. Meaning: Something hanging by a thread / in a precarious situation.</div>
            </div>
          </div>
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-[var(--text)] mb-6">Tips for Learning Phrases in Context (Not Just Memorizing)</h2>
          ...
          <div className="bg-[var(--surface)] p-6 rounded-xl border border-[var(--border)] mb-6">
            <div className="flex items-center gap-2 mb-3"><Star className="w-5 h-5 text-[#C81FD4]" /><span className="font-semibold text-[var(--text)]">Save Phrases You Encounter Naturally</span></div>
          ...
          <div className="bg-[var(--surface)] p-6 rounded-xl border border-[var(--border)] mb-6">
            <div className="flex items-center gap-2 mb-3"><Languages className="w-5 h-5 text-[#C81FD4]" /><span className="font-semibold text-[var(--text)]">Learn the Equivalent, Not the Literal Translation</span></div>
            <p className="text-[var(--text-dim)]">When you learn that &quot;Die Daumen dr&uuml;cken&quot; means &quot;to cross your fingers,&quot; store it as the equivalent English gesture, not as &quot;press the thumbs.&quot; This way your brain maps the German phrase directly to the concept rather than routing through a confusing literal translation. Over time, you will think in phrases rather than translating word by word.</p>
          </div>

          <div className="bg-[var(--surface)] p-6 rounded-xl border border-[var(--border)] mb-6">
            <div className="flex items-center gap-2 mb-3"><MessageSquare className="w-5 h-5 text-[#C81FD4]" /><span className="font-semibold text-[var(--text)]">Use Phrases Immediately After Learning Them</span></div>
          ...
          <div className="bg-[var(--surface)] p-6 rounded-xl border border-[var(--border)] mb-6">
            <div className="flex items-center gap-2 mb-3"><Globe className="w-5 h-5 text-[#C81FD4]" /><span className="font-semibold text-[var(--text)]">Group Phrases by Theme, Not by Language Rule</span></div>
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-[var(--text)] mb-6">How Funlingo Helps You Learn Phrases by Watching Shows</h2>
          ...
          <p className="text-[var(--text-dim)] mb-6">The extension is completely free. No premium tiers, no usage limits, no trial periods. You install it, pick your languages, and start learning phrases in context immediately.</p>
            ...
            <table className="w-full text-sm text-[var(--text-dim)]">
              <thead>
                <tr className="border-b border-[var(--border)]">
                  ...
                  <th className="text-left py-2 pr-4 text-[var(--text)]">Phrase Accuracy</th>
                  <th className="text-left py-2 pr-4 text-[var(--text)]">Explains Meaning</th>
                  <th className="text-left py-2 pr-4 text-[var(--text)]">Languages</th>
                  <th className="text-left py-2 text-[var(--text)]">Free</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b border-[var(--border)]"><td className="py-2 pr-4">ChatGPT</td><td className="py-2 pr-4">Excellent</td><td className="py-2 pr-4">Yes, in depth</td><td className="py-2 pr-4">90+</td><td className="py-2">Limited</td></tr>
                <tr className="border-b border-[var(--border)]"><td className="py-2 pr-4">Claude</td><td className="py-2 pr-4">Excellent</td><td className="py-2 pr-4">Yes, with context</td><td className="py-2 pr-4">90+</td><td className="py-2">Limited</td></tr>
                <tr className="border-b border-[var(--border)]"><td className="py-2 pr-4">DeepL</td><td className="py-2 pr-4">Very good</td><td className="py-2 pr-4">No</td><td className="py-2 pr-4">33</td><td className="py-2">Limited</td></tr>
                <tr className="border-b border-[var(--border)]"><td className="py-2 pr-4">Google Translate</td><td className="py-2 pr-4">Good (common)</td><td className="py-2 pr-4">No</td><td className="py-2 pr-4">133+</td><td className="py-2">Yes</td></tr>
                <tr className="border-b border-[var(--border)]"><td className="py-2 pr-4">Reverso Context</td><td className="py-2 pr-4">Very good</td><td className="py-2 pr-4">Via examples</td><td className="py-2 pr-4">18</td><td className="py-2">Yes</td></tr>
                <tr className="border-b border-[var(--border)]"><td className="py-2 pr-4">Linguee</td><td className="py-2 pr-4">Good (formal)</td><td className="py-2 pr-4">Via examples</td><td className="py-2 pr-4">25</td><td className="py-2">Yes</td></tr>
                <tr className="border-b border-[var(--border)]"><td className="py-2 pr-4">WordReference</td><td className="py-2 pr-4">Very good</td><td className="py-2 pr-4">Via forums</td><td className="py-2 pr-4">19</td><td className="py-2">Yes</td></tr>
          ...
          <div className="bg-[var(--surface)] p-6 rounded-xl border border-[var(--border)] mb-6">
            <h3 className="text-lg font-semibold text-[var(--text)] mb-2">Why do regular translators fail at translating phrases?</h3>
          ...
          <div className="bg-[var(--surface)] p-6 rounded-xl border border-[var(--border)] mb-6">
            <h3 className="text-lg font-semibold text-[var(--text)] mb-2">What is the best tool for translating idioms?</h3>
          ...
          <div className="bg-[var(--surface)] p-6 rounded-xl border border-[var(--border)] mb-6">
            <h3 className="text-lg font-semibold text-[var(--text)] mb-2">Can Google Translate handle slang and colloquial expressions?</h3>
          ...
          <div className="bg-[var(--surface)] p-6 rounded-xl border border-[var(--border)] mb-6">
            <h3 className="text-lg font-semibold text-[var(--text)] mb-2">How can I learn idioms in another language without memorizing lists?</h3>
