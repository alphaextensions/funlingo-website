    ...
    <div className="flex flex-col min-h-screen bg-[var(--bg)]">
      ...
      <section className="relative w-full py-16 lg:py-24 px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto flex flex-col gap-6 text-center lg:text-left">
          ...
          <h1 className="font-heading-h1 text-3xl sm:text-4xl lg:text-5xl font-bold text-[var(--text)] leading-tight">7 Best Dual Subtitle Extensions for Language Learning (2026)</h1>
      ...
      <main className="w-full max-w-3xl mx-auto px-6 pb-24">
        <div className="prose prose-lg max-w-none text-[var(--text-dim)]">
          ...
          />
          <h2 className="text-2xl font-bold text-[var(--text)] mb-4">What Are Dual Subtitle Extensions?</h2>
          <p className="leading-relaxed text-[var(--text-dim)] mb-6">Dual subtitle extensions are Chrome browser add-ons that display two sets of subtitles simultaneously while you watch videos on streaming platforms. You see your target language and your native language on screen at the same time, letting you follow along without constantly pausing to look up translations.</p>
          <p className="lead text-xl leading-relaxed text-[var(--text)] mb-6">This approach is backed by research on comprehensible input. When you understand what you hear in context, your brain acquires language naturally. Dual subtitles provide the scaffolding that makes input comprehensible, even for beginners.</p>
          <p className="text-[var(--text-dim)] mb-6">If you want to understand the broader methodology behind learning with media, read our guide on <a href="/blog/how-to-learn-a-language-by-watching" className="text-[#C81FD4] hover:underline">how to learn a language by watching</a>.</p>

          <div className="mt-8 text-center py-8 px-6 rounded-2xl bg-[rgba(200,31,212,0.05)] border border-[#C81FD4]/20">
            <p className="text-lg text-[var(--text)] mb-6">Want the best free dual subtitle extension? Try Funlingo today.</p>
          ...
          <img
            ...
            loading="lazy"
          />
          <h2 className="text-2xl sm:text-3xl font-bold text-[var(--text)] mb-6">The 7 Best Dual Subtitle Extensions Compared</h2>
          <p className="text-[var(--text-dim)] mb-8">We tested every major dual subtitle extension in 2026. Here is how they compare across price, platform support, features, and usability.</p>

          <h3 className="text-xl font-bold text-[var(--text)] mb-4">1. Funlingo — Best Free Dual Subtitle Extension</h3>
          ...
          <h3 className="text-xl font-bold text-[var(--text)] mb-4">2. <a href="https://www.languagereactor.com" target="_blank" rel="noopener noreferrer" className="text-[var(--text)] hover:text-[#C81FD4] transition-colors">Language Reactor</a> — Most Popular Option</h3>
          ...
          <h3 className="text-xl font-bold text-[var(--text)] mb-4">3. Substital — Best for Custom Subtitle Files</h3>
          <div className="bg-[var(--surface)] p-6 rounded-xl border border-[var(--border)] mb-8">
          ...
          <h3 className="text-xl font-bold text-[var(--text)] mb-4">4. <a href="https://ejoy-english.com" target="_blank" rel="noopener noreferrer" className="text-[var(--text)] hover:text-[#C81FD4] transition-colors">eJOY English</a> — Best for English Learners</h3>
          <div className="bg-[var(--surface)] p-6 rounded-xl border border-[var(--border)] mb-8">
            <p className="text-[var(--text-dim)] mb-4">eJOY is primarily designed for people learning English. It offers dual subtitles and a word-saving feature with games for review. The free plan is limited to saving a small number of words per day. Full access requires a subscription starting at around $5 per month.</p>
            <div className="grid grid-cols-2 gap-2 text-sm">
              <div className="flex items-center gap-2 text-green-400"><Check className="w-4 h-4" /> Netflix, YouTube</div>
          ...
          <h3 className="text-xl font-bold text-[var(--text)] mb-4">5. Toucan — Best for Passive Learning</h3>
          <div className="bg-[var(--surface)] p-6 rounded-xl border border-[var(--border)] mb-8">
            <p className="text-[var(--text-dim)] mb-4">Toucan takes a different approach by translating individual words on web pages you browse. It is not a traditional dual subtitle tool but works well as a supplementary passive learning method. It is free with limited language pairs.</p>
            <div className="grid grid-cols-2 gap-2 text-sm">
          ...
          <h3 className="text-xl font-bold text-[var(--text)] mb-4">6. <a href="https://www.trancy.org" target="_blank" rel="noopener noreferrer" className="text-[var(--text)] hover:text-[#C81FD4] transition-colors">Trancy</a> — Best AI-Powered Option</h3>
          <div className="bg-[var(--surface)] p-6 rounded-xl border border-[var(--border)] mb-8">
          ...
          <h3 className="text-xl font-bold text-[var(--text)] mb-4">7. <a href="https://immersivetranslate.com" target="_blank" rel="noopener noreferrer" className="text-[var(--text)] hover:text-[#C81FD4] transition-colors">Immersive Translate</a> — Best for General Translation</h3>
          <div className="bg-[var(--surface)] p-6 rounded-xl border border-[var(--border)] mb-8">
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-[var(--text)] mb-6">How to Choose the Right Extension</h2>
          <p className="text-[var(--text-dim)] mb-6">With seven options to consider, here is a simple framework for choosing the right dual subtitle extension for your needs.</p>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
            <div className="bg-[var(--surface)] p-6 rounded-xl border border-[var(--border)]"><DollarSign className="w-8 h-8 text-[#C81FD4] mb-4" /><h3 className="text-xl font-bold text-[var(--text)] mb-2">On a Budget?</h3><p className="text-sm text-[var(--text-dim)]">Choose Funlingo. It is the only fully free option with no feature restrictions across Netflix, YouTube, and Prime Video.</p></div>
            <div className="bg-[var(--surface)] p-6 rounded-xl border border-[var(--border)]"><Globe className="w-8 h-8 text-[#C81FD4] mb-4" /><h3 className="text-xl font-bold text-[var(--text)] mb-2">Need Multiple Platforms?</h3><p className="text-sm text-[var(--text-dim)]">Funlingo covers Netflix, YouTube, and Prime Video. Most competitors only support two of these three.</p></div>
            <div className="bg-[var(--surface)] p-6 rounded-xl border border-[var(--border)]"><Shield className="w-8 h-8 text-[#C81FD4] mb-4" /><h3 className="text-xl font-bold text-[var(--text)] mb-2">Want Vocabulary Building?</h3><p className="text-sm text-[var(--text-dim)]">Look for built-in word saving and spaced repetition. Funlingo and Language Reactor both offer this, but Funlingo does it for free.</p></div>
            <div className="bg-[var(--surface)] p-6 rounded-xl border border-[var(--border)]"><Zap className="w-8 h-8 text-[#C81FD4] mb-4" /><h3 className="text-xl font-bold text-[var(--text)] mb-2">Want AI Features?</h3><p className="text-sm text-[var(--text-dim)]">Trancy offers AI-powered grammar analysis, but at a premium price point of $8 per month.</p></div>
          </div>

          <h2 className="text-2xl sm:text-3xl font-bold text-[var(--text)] mb-6">Getting Started with Dual Subtitles</h2>
          <p className="text-[var(--text-dim)] mb-6">Once you choose your extension, getting started takes less than a minute. For a step-by-step walkthrough, check out our guide on <a href="/blog/how-to-get-dual-subtitles-on-netflix" className="text-[#C81FD4] hover:underline">how to get dual subtitles on Netflix</a>.</p>
          <p className="text-[var(--text-dim)] mb-6">After you are set up, you can start <a href="/blog/vocabulary-building-watching-shows" className="text-[#C81FD4] hover:underline">building vocabulary while watching shows</a> using proven strategies that turn passive viewing into active learning.</p>
          ...
          <div className="bg-[var(--surface)] p-6 rounded-xl border border-[var(--border)] mb-12">
            ...
            <div className="space-y-4">
              <div><strong className="text-[var(--text)] block mb-1">What is the best free dual subtitle extension?</strong><p className="text-[var(--text-dim)] text-sm">Funlingo is the best free dual subtitle extension. It supports Netflix, YouTube, and Prime Video with no premium paywall or feature restrictions.</p></div>
              <div><strong className="text-[var(--text)] block mb-1">Do dual subtitle extensions work on all streaming platforms?</strong><p className="text-[var(--text-dim)] text-sm">Most extensions support Netflix and YouTube. Funlingo also supports Amazon Prime Video, making it one of the most versatile options.</p></div>
              <div><strong className="text-[var(--text)] block mb-1">Are dual subtitle extensions safe to use?</strong><p className="text-[var(--text-dim)] text-sm">Yes, reputable extensions like Funlingo are safe. Always install from the official Chrome Web Store and check reviews.</p></div>
              <div><strong className="text-[var(--text)] block mb-1">Can I use dual subtitles on mobile devices?</strong><p className="text-[var(--text-dim)] text-sm">Dual subtitle extensions are Chrome-only and work on desktop browsers. Mobile streaming apps do not support Chrome extensions.</p></div>
              <div><strong className="text-[var(--text)] block mb-1">What is the difference between dual subtitles and closed captions?</strong><p className="text-[var(--text-dim)] text-sm">Closed captions show text in one language. Dual subtitles display two languages simultaneously, letting you read the translation alongside the original dialogue.</p></div>
            </div>
          </div>

          <div className="mt-20 text-center py-12 px-6 rounded-2xl bg-[rgba(200,31,212,0.05)] border border-[#C81FD4]/20">
            <h2 className="text-3xl font-bold text-[var(--text)] mb-4">Try the Best Free Dual Subtitle Extension</h2>
            <p className="text-lg text-[var(--text-dim)] mb-8 max-w-xl mx-auto">Dual subtitles on Netflix, YouTube, and Prime Video. Built-in vocabulary builder. Completely free, forever.</p>
            <a href="https://chromewebstore.google.com/detail/funlingo-dual-subtitles-f/gjdpaicenfffjkgofmcjikilokigkonj?hl=en" target="_blank" rel="noopener noreferrer" className="no-underline">
