    ...
    <div className="flex flex-col min-h-screen bg-[var(--bg)]">
      ...
      <section className="relative w-full py-16 lg:py-24 px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto flex flex-col gap-6 text-center lg:text-left">
          <Badge className="w-fit mx-auto lg:mx-0 bg-[rgba(200,31,212,0.1)] text-[#C81FD4] border-[#C81FD4]/20 px-3 py-1">Chinese Content</Badge>
          <h1 className="font-heading-h1 text-3xl sm:text-4xl lg:text-5xl font-bold text-[var(--text)] leading-tight">Download YouTube Videos with Chinese Subtitles &mdash; 3 Free Methods (2026 Guide)</h1>
        ...
        <div className="prose prose-invert prose-lg max-w-none text-[var(--text-dim)]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
            <div className="bg-[var(--surface)] p-6 rounded-xl border border-[var(--border)]">
              ...
              <h3 className="text-xl font-bold text-[var(--text)] mb-2">Offline Study Sessions</h3>
              <p className="text-sm text-[var(--text-dim)]">Save videos to your phone or tablet and study Chinese during commutes, flights, or anywhere without Wi-Fi. Having subtitles embedded means you never lose the learning context.</p>
            </div>
            <div className="bg-[var(--surface)] p-6 rounded-xl border border-[var(--border)]">
              <Monitor className="w-8 h-8 text-red-400 mb-4" />
              <h3 className="text-xl font-bold text-[var(--text)] mb-2">Review Difficult Passages</h3>
              <p className="text-sm text-[var(--text-dim)]">Some Chinese phrases need repeated listening. Downloaded videos let you loop specific sections in a media player without buffering delays or ads interrupting your flow.</p>
            </div>
            <div className="bg-[var(--surface)] p-6 rounded-xl border border-[var(--border)]">
              <Globe className="w-8 h-8 text-red-400 mb-4" />
              <h3 className="text-xl font-bold text-[var(--text)] mb-2">Build a Personal Library</h3>
              <p className="text-sm text-[var(--text-dim)]">Curate a collection of Chinese videos organized by topic and difficulty level. Over time, this becomes your personalized immersion library tailored to your learning goals.</p>
            </div>
            <div className="bg-[var(--surface)] p-6 rounded-xl border border-[var(--border)]">
              <Clock className="w-8 h-8 text-red-400 mb-4" />
              <h3 className="text-xl font-bold text-[var(--text)] mb-2">Subtitle File Extraction</h3>
              <p className="text-sm text-[var(--text-dim)]">Extract Chinese subtitle files (SRT or VTT) separately and use them with flashcard tools like Anki, or load them into translation software for deeper vocabulary study.</p>
            </div>
          </div>
          ...
          {/* Method 1: yt-dlp */}
          <h2 className="text-2xl sm:text-3xl font-bold text-[var(--text)] mb-6">Method 1: yt-dlp Command Line (Most Powerful)</h2>
          <p className="text-[var(--text-dim)] mb-6">yt-dlp is a free, open-source command-line tool and the successor to the now-deprecated youtube-dl. It is the most powerful and flexible way to download YouTube videos with subtitles in any language, including Chinese (Simplified and Traditional). If you are comfortable with a terminal, this is the gold standard.</p>
...
yt-dlp --write-sub --sub-lang zh-Hans --embed-subs "https://www.youtube.com/playlist?list=PLAYLIST_ID"`}</code></pre>
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-[var(--text)] mb-6">Method 2: Online Subtitle Download Tools (Easiest)</h2>
          <p className="text-[var(--text-dim)] mb-6">If you do not want to install anything, several online tools let you extract Chinese subtitles from YouTube videos directly in your browser. These are the simplest option, though they usually only download the subtitle file itself, not the video.</p>

          <div className="bg-[var(--surface)] p-6 rounded-xl border border-[var(--border)] mb-6">
            <h3 className="text-xl font-semibold text-[var(--text)] mb-3">SaveSubs</h3>
            <p className="text-[var(--text-dim)] mb-3">SaveSubs is one of the most popular online tools for downloading YouTube subtitles. Simply paste the video URL, select Chinese from the language list, and download the subtitle file in SRT or TXT format. It supports both human-written and auto-generated subtitles.</p>
            <p className="text-[var(--text-dim)] text-sm mb-3"><strong className="text-[var(--text)]">URL:</strong> savesubs.com &nbsp;|&nbsp; <strong className="text-[var(--text)]">Formats:</strong> SRT, TXT, VTT</p>
            <div className="flex flex-col gap-2 text-sm">
          ...
          <div className="bg-[var(--surface)] p-6 rounded-xl border border-[var(--border)] mb-6">
            <h3 className="text-xl font-semibold text-[var(--text)] mb-3">DownSub</h3>
            <p className="text-[var(--text-dim)] mb-3">DownSub extracts subtitles from YouTube, Viki, VLive, and other platforms. It automatically detects all available languages and lets you download any of them as SRT or TXT files. DownSub also offers a translation feature that can machine-translate subtitles into Chinese if the original language is different.</p>
            <p className="text-[var(--text-dim)] text-sm mb-3"><strong className="text-[var(--text)]">URL:</strong> downsub.com &nbsp;|&nbsp; <strong className="text-[var(--text)]">Formats:</strong> SRT, TXT</p>
            <div className="flex flex-col gap-2 text-sm">
          ...
          <div className="bg-[var(--surface)] p-6 rounded-xl border border-[var(--border)] mb-6">
            <h3 className="text-xl font-semibold text-[var(--text)] mb-3">YouTubeTranscript.com</h3>
            <p className="text-[var(--text-dim)] mb-3">This tool generates a full text transcript of any YouTube video with timestamps. Paste the URL, choose Chinese, and you get a timestamped transcript you can copy or download. It is especially useful when you want to study the text alongside the video without needing a separate subtitle file.</p>
            <p className="text-[var(--text-dim)] text-sm mb-3"><strong className="text-[var(--text)]">URL:</strong> youtubetranscript.com &nbsp;|&nbsp; <strong className="text-[var(--text)]">Formats:</strong> TXT with timestamps</p>
            <div className="flex flex-col gap-2 text-sm">
          ...
          <h3 className="text-xl font-semibold text-[var(--text)] mb-4">How to Use Online Tools (General Steps)</h3>
          <div className="space-y-6 relative before:absolute before:left-[19px] before:top-4 before:bottom-4 before:w-0.5 before:bg-[var(--surface-2)] mb-12">
            {[
              ...
              <div key={i} className="flex gap-6 relative"><div className="w-10 h-10 rounded-full bg-[#1a1a1a] border border-red-400/50 flex items-center justify-center text-red-400 font-bold shrink-0 z-10">{i + 1}</div><div className="pt-2 text-[var(--text-dim)]"><strong className="text-[var(--text)] block mb-1">{s.title}</strong>{s.desc}</div></div>
            ))}
          </div>
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-[var(--text)] mb-6">Method 3: Browser Extensions</h2>
          <p className="text-[var(--text-dim)] mb-6">Several Chrome and Firefox extensions can download YouTube videos or extract subtitles directly from your browser. These offer a middle ground between the power of yt-dlp and the simplicity of online tools.</p>

          <div className="bg-[var(--surface)] p-6 rounded-xl border border-[var(--border)] mb-6">
            <h3 className="text-xl font-semibold text-[var(--text)] mb-3">Subtitle Downloader Extensions</h3>
            <p className="text-[var(--text-dim)] mb-3">Extensions like <strong className="text-[var(--text)]">Substital</strong> and <strong className="text-[var(--text)]">YouTube Subtitle Downloader</strong> add a download button directly on the YouTube player page. When you click it, you can select Chinese and download the subtitle file in SRT format. These are convenient because they integrate right into your browsing workflow.</p>
            <div className="flex flex-col gap-2 text-sm">
          ...
          <div className="bg-[var(--surface)] p-6 rounded-xl border border-[var(--border)] mb-6">
            <h3 className="text-xl font-semibold text-[var(--text)] mb-3">Video Downloader Extensions</h3>
            <p className="text-[var(--text-dim)] mb-3">Extensions like <strong className="text-[var(--text)]">Video DownloadHelper</strong> can download the actual video file from many sites. However, most video downloader extensions do not embed subtitles into the downloaded file. You would need to download the video and subtitle file separately, then combine them using a media player like VLC or a tool like FFmpeg.</p>
            <div className="flex flex-col gap-2 text-sm">
            ...
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr className="border-b border-[var(--border)]">
                  <th className="text-left py-3 pr-4 text-[var(--text)] font-semibold">Feature</th>
                  <th className="text-center py-3 px-4 text-[var(--text)] font-semibold">yt-dlp</th>
                  <th className="text-center py-3 px-4 text-[var(--text)] font-semibold">Online Tools</th>
                  <th className="text-center py-3 px-4 text-[var(--text)] font-semibold">Extensions</th>
                  <th className="text-center py-3 pl-4 text-[var(--text)] font-semibold">Funlingo</th>
                </tr>
              </thead>
              <tbody className="text-[var(--text-dim)]">
                <tr className="border-b border-[var(--border)]">
                  ...
                  <td className="text-center py-3 px-4"><Check className="w-4 h-4 text-green-400 mx-auto" /></td>
                  <td className="text-center py-3 pl-4"><X className="w-4 h-4 text-[var(--text-dim2)] mx-auto" /></td>
                </tr>
                <tr className="border-b border-[var(--border)]">
                ...
                <tr className="border-b border-[var(--border)]">
                  ...
                  <td className="text-center py-3 px-4 text-[var(--text-dim2)]">Manual</td>
                  <td className="text-center py-3 px-4"><X className="w-4 h-4 text-red-400 mx-auto" /></td>
                  <td className="text-center py-3 px-4"><X className="w-4 h-4 text-red-400 mx-auto" /></td>
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-[var(--text)] mb-6">A Better Alternative: Watch with Dual Chinese Subtitles (No Downloading)</h2>
          <p className="text-[var(--text-dim)] mb-6">Downloading videos is useful for offline access, but if your primary goal is learning Chinese, there is a faster and more effective approach. Instead of downloading, you can watch YouTube videos with dual subtitles in real time, seeing Chinese and your native language simultaneously on the screen.</p>
          ...
          <DualSubtitleDemo targetLang="Chinese" target="我今天学了一个新词。" highlight="新词" native="I learned a new word today." />

          <div className="bg-gradient-to-br from-red-900/20 to-transparent p-8 rounded-xl border border-red-400/20 mb-12">
            <h3 className="text-2xl font-bold text-[var(--text)] mb-6 mt-0">Why Funlingo Beats Downloading for Chinese Learning</h3>
            <div className="space-y-4">
              <div className="flex flex-col md:flex-row gap-4 border-b border-[var(--border)] pb-4">
                <div className="flex-1">
                  <span className="text-red-400 text-sm uppercase tracking-wider block mb-1">Real-Time Dual Subtitles</span>
                  <span className="text-[var(--text)] font-medium">See Chinese characters and English (or any language) side by side as you watch. No file management, no syncing issues, no extra steps.</span>
                </div>
              </div>
              <div className="flex flex-col md:flex-row gap-4 border-b border-[var(--border)] pb-4">
                <div className="flex-1">
                  <span className="text-red-400 text-sm uppercase tracking-wider block mb-1">Click Any Word to Translate</span>
                  <span className="text-[var(--text)] font-medium">Click any Chinese character or word in the subtitles to see its pinyin, pronunciation, and meaning instantly. No copying to a separate dictionary app.</span>
                </div>
              </div>
              <div className="flex flex-col md:flex-row gap-4 border-b border-[var(--border)] pb-4">
                <div className="flex-1">
                  <span className="text-red-400 text-sm uppercase tracking-wider block mb-1">Works on YouTube, Netflix, and Prime Video</span>
                  <span className="text-[var(--text)] font-medium">One extension covers all three major streaming platforms. Watch Chinese dramas on Netflix, Chinese vlogs on YouTube, and Chinese films on Prime Video with dual subtitles.</span>
                </div>
              </div>
              <div className="flex flex-col md:flex-row gap-4">
                <div className="flex-1">
                  <span className="text-red-400 text-sm uppercase tracking-wider block mb-1">Completely Free</span>
                  <span className="text-[var(--text)] font-medium">Funlingo is free to use with no hidden paywalls, premium tiers, or trial periods. Dual subtitles, word lookup, and vocabulary saving are all included at no cost.</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-[var(--text)] mb-6">Best Chinese YouTube Channels for Language Learning</h2>
          <p className="text-[var(--text-dim)] mb-6">Whether you download videos or use Funlingo for real-time dual subtitles, you need great content. Here are the best Chinese YouTube channels organized by category and difficulty level.</p>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
            <div className="bg-[var(--surface)] p-6 rounded-xl border border-[var(--border)]">
              <h3 className="text-xl font-bold text-[var(--text)] mb-2">Mandarin Corner</h3>
              <p className="text-sm text-[var(--text-dim)] mb-2">Street interviews and real-life conversations in Mandarin with pinyin and English subtitles. Content ranges from beginner to advanced and covers everyday topics that teach practical, usable Chinese.</p>
              <Badge className="bg-green-900/30 text-green-400 border-green-400/20 text-xs">Beginner to Advanced</Badge>
            </div>
            <div className="bg-[var(--surface)] p-6 rounded-xl border border-[var(--border)]">
              <h3 className="text-xl font-bold text-[var(--text)] mb-2">Li Ziqi</h3>
              <p className="text-sm text-[var(--text-dim)] mb-2">Beautiful cinematic videos about traditional Chinese cooking and rural life. Minimal dialogue but excellent for cultural immersion and learning food and nature vocabulary at a gentle pace.</p>
              <Badge className="bg-blue-900/30 text-blue-400 border-blue-400/20 text-xs">Beginner</Badge>
            </div>
            <div className="bg-[var(--surface)] p-6 rounded-xl border border-[var(--border)]">
              <h3 className="text-xl font-bold text-[var(--text)] mb-2">ChinesePod</h3>
              <p className="text-sm text-[var(--text-dim)] mb-2">Structured Mandarin lessons organized by proficiency level. Each video focuses on a specific grammar point or vocabulary theme with clear explanations and example sentences.</p>
              <Badge className="bg-green-900/30 text-green-400 border-green-400/20 text-xs">Beginner to Intermediate</Badge>
            </div>
            <div className="bg-[var(--surface)] p-6 rounded-xl border border-[var(--border)]">
              <h3 className="text-xl font-bold text-[var(--text)] mb-2">CCTV Chinese</h3>
              <p className="text-sm text-[var(--text-dim)] mb-2">Official CCTV channel with news broadcasts, documentaries, and cultural programs. Formal Mandarin with clear pronunciation, ideal for learners targeting professional or academic Chinese.</p>
              <Badge className="bg-orange-900/30 text-orange-400 border-orange-400/20 text-xs">Intermediate to Advanced</Badge>
            </div>
            <div className="bg-[var(--surface)] p-6 rounded-xl border border-[var(--border)]">
              <h3 className="text-xl font-bold text-[var(--text)] mb-2">Xiao Ma NYC</h3>
              <p className="text-sm text-[var(--text-dim)] mb-2">A polyglot who speaks Mandarin on the streets of New York, surprising native speakers. Fun, engaging content that demonstrates natural conversational Chinese in real-world interactions.</p>
              <Badge className="bg-blue-900/30 text-blue-400 border-blue-400/20 text-xs">Beginner to Intermediate</Badge>
            </div>
            <div className="bg-[var(--surface)] p-6 rounded-xl border border-[var(--border)]">
              <h3 className="text-xl font-bold text-[var(--text)] mb-2">Dashu Mandarin</h3>
              <p className="text-sm text-[var(--text-dim)] mb-2">Short, focused lessons on Chinese grammar, sentence patterns, and common mistakes. Great for learners who want structured explanations alongside their immersion practice.</p>
              <Badge className="bg-green-900/30 text-green-400 border-green-400/20 text-xs">Beginner to Intermediate</Badge>
            </div>
          </div>

          <p className="text-[var(--text-dim)] mb-6">For more strategies on learning through video content, check out our guide on <a href="/blog/how-to-learn-a-language-by-watching" className="text-[#C81FD4] hover:underline">how to learn a language by watching</a> and tips for <a href="/blog/vocabulary-building-watching-shows" className="text-[#C81FD4] hover:underline">building vocabulary while watching shows</a>.</p>
          ...
          <div className="bg-[var(--surface)] p-6 rounded-xl border border-[var(--border)] mb-12">
            ...
            <div className="space-y-4">
              <div>
                <strong className="text-[var(--text)] block mb-1">How do I download YouTube videos with Chinese subtitles?</strong>
                <p className="text-[var(--text-dim)] text-sm">The most reliable method is yt-dlp with the command <code className="text-red-400 bg-[var(--surface)] px-1 rounded">yt-dlp --write-sub --sub-lang zh-Hans --embed-subs URL</code>. For a simpler approach, use online tools like SaveSubs or DownSub to extract just the subtitle file. For real-time Chinese learning without downloading, install the free Funlingo Chrome extension for dual subtitles.</p>
              </div>
              <div>
                <strong className="text-[var(--text)] block mb-1">Can I watch YouTube with Chinese and English subtitles at the same time?</strong>
                <p className="text-[var(--text-dim)] text-sm">Yes. Funlingo is a free Chrome extension that displays dual subtitles on YouTube, showing Chinese and English (or any other language pair) simultaneously. No downloading or subtitle file management required.</p>
              </div>
              <div>
                <strong className="text-[var(--text)] block mb-1">Are auto-generated Chinese subtitles on YouTube accurate?</strong>
                <p className="text-[var(--text-dim)] text-sm">YouTube&apos;s auto-generated Chinese subtitles have improved significantly but are not perfect, especially with fast speech, accents, or specialized vocabulary. For language learning, videos with manually created Chinese subtitles are more reliable. Funlingo works with both auto-generated and manual subtitles.</p>
              </div>
              <div>
                <strong className="text-[var(--text)] block mb-1">Is it legal to download YouTube videos with Chinese subtitles?</strong>
                <p className="text-[var(--text-dim)] text-sm">Downloading YouTube videos is against YouTube&apos;s Terms of Service unless the video has a download option enabled by the creator. Downloading subtitle files alone (without the video) falls into a grayer area. For a completely compliant approach, use Funlingo to watch with dual subtitles directly on YouTube without downloading anything.</p>
              </div>
              <div>
                <strong className="text-[var(--text)] block mb-1">What is the best format for Chinese subtitle files?</strong>
                <p className="text-[var(--text-dim)] text-sm">SRT (SubRip) is the most widely supported format and works with nearly every media player including VLC, MPV, and PotPlayer. VTT (WebVTT) is another good option, especially for web-based players. Both formats handle Chinese characters without issues as long as the file encoding is UTF-8.</p>
              </div>
            </div>
          </div>
