    ...
    <div className="flex flex-col min-h-screen bg-[var(--bg)]">
      ...
      <section className="relative w-full py-16 lg:py-24 px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto flex flex-col gap-6 text-center lg:text-left">
          <Badge className="w-fit mx-auto lg:mx-0 bg-[rgba(200,31,212,0.1)] text-[#C81FD4] border-[#C81FD4]/20 px-3 py-1">Comparison</Badge>
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-[var(--text)] leading-tight">Language Reactor vs Trancy: Which Is Better in 2026?</h1>
      ...
      <main className="w-full max-w-3xl mx-auto px-6 pb-24">
        <div className="prose prose-invert prose-lg max-w-none text-[var(--text-dim)]">
          ...
          <p>If you want a broader overview of all the tools available, check out our guide to the <a href="/blog/best-dual-subtitle-extension" className="text-[#C81FD4] hover:underline">best dual subtitle extensions</a> or our deep dive into <a href="/blog/netflix-language-learning-extensions" className="text-[#C81FD4] hover:underline">Netflix language learning extensions</a>. Looking for more options beyond these two? Check our roundup of <a href="/blog/language-reactor-alternatives" className="text-[#C81FD4] hover:underline">Language Reactor alternatives</a>.</p>

          <hr className="border-[var(--border)] my-10" />

          {/* Quick Overview */}
          <h2 className="text-3xl font-bold text-[var(--text)]">Quick Overview</h2>
          ...
          <div className="grid sm:grid-cols-2 gap-4 my-8">
            <div className="bg-[var(--surface)] rounded-xl p-6 border border-[var(--border)]">
              <h3 className="text-xl font-bold text-[var(--text)] mt-0 mb-2"><a href="https://www.languagereactor.com" target="_blank" rel="noopener noreferrer" className="text-[var(--text)] hover:text-[#C81FD4] transition-colors">Language Reactor</a></h3>
              <p className="text-sm text-[var(--text-dim)] mb-3">Est. 2019 &middot; 1M+ users</p>
              <ul className="space-y-1 list-none pl-0 m-0 text-sm">
                <li className="flex items-center gap-2 text-[var(--text-dim)]"><DollarSign className="w-4 h-4 text-[#C81FD4]" /> $6/mo (Pro)</li>
                <li className="flex items-center gap-2 text-[var(--text-dim)]"><Monitor className="w-4 h-4 text-[#C81FD4]" /> Netflix, YouTube</li>
                <li className="flex items-center gap-2 text-[var(--text-dim)]"><Globe className="w-4 h-4 text-[#C81FD4]" /> 40+ languages</li>
              </ul>
            </div>
            <div className="bg-[var(--surface)] rounded-xl p-6 border border-[var(--border)]">
              <h3 className="text-xl font-bold text-[var(--text)] mt-0 mb-2"><a href="https://www.trancy.org" target="_blank" rel="noopener noreferrer" className="text-[var(--text)] hover:text-[#C81FD4] transition-colors">Trancy</a></h3>
              <p className="text-sm text-[var(--text-dim)] mb-3">Est. 2023 &middot; 500K+ users</p>
              <ul className="space-y-1 list-none pl-0 m-0 text-sm">
                <li className="flex items-center gap-2 text-[var(--text-dim)]"><DollarSign className="w-4 h-4 text-[#C81FD4]" /> $8/mo (Pro)</li>
                <li className="flex items-center gap-2 text-[var(--text-dim)]"><Monitor className="w-4 h-4 text-[#C81FD4]" /> Netflix, YouTube, Disney+, more</li>
                <li className="flex items-center gap-2 text-[var(--text-dim)]"><Globe className="w-4 h-4 text-[#C81FD4]" /> 30+ languages</li>
              </ul>
            </div>
          </div>
          ...
          {/* Pricing */}
          <h2 className="text-3xl font-bold text-[var(--text)]">Pricing Comparison</h2>
          ...
          <div className="bg-[var(--surface)] rounded-xl p-6 border border-[var(--border)] my-8">
            <h3 className="text-xl font-bold text-[var(--text)] mt-0 mb-4">Language Reactor Pricing</h3>
            <p className="text-[var(--text-dim)] mb-2">Language Reactor offers a free tier with basic dual subtitles on Netflix and YouTube. The Pro plan costs <strong className="text-[var(--text)]">$6 per month</strong> (or $48/year) and unlocks machine translations, phonetic transcriptions (romaji, pinyin), vocabulary export to <a href="https://apps.ankiweb.net" target="_blank" rel="noopener noreferrer" className="text-[#C81FD4] hover:underline">Anki</a>, and the catalogue mode for finding content by difficulty level. The free tier is surprisingly usable, but the vocabulary features are locked behind the paywall.</p>
          </div>

          <div className="bg-[var(--surface)] rounded-xl p-6 border border-[var(--border)] my-8">
            <h3 className="text-xl font-bold text-[var(--text)] mt-0 mb-4">Trancy Pricing</h3>
            <p className="text-[var(--text-dim)] mb-2">Trancy also has a free tier, but it is more restrictive &mdash; you get limited daily AI queries and basic subtitle display. The Pro plan is <strong className="text-[var(--text)]">$8 per month</strong> (or $60/year) and unlocks unlimited AI grammar analysis, sentence-by-sentence replay mode, full platform support, and advanced vocabulary tools. While it costs more, the AI grammar feature is genuinely unique.</p>
          </div>
          ...
          <h2 className="text-3xl font-bold text-[var(--text)]">Feature-by-Feature Comparison</h2>
          ...
          <div className="bg-[var(--surface)] rounded-xl border border-[var(--border)] my-8 overflow-hidden">
            <div className="grid grid-cols-3 gap-0 text-sm">
              <div className="p-4 font-bold text-[var(--text)] bg-[var(--surface)] border-b border-[var(--border)]">Feature</div>
              <div className="p-4 font-bold text-[var(--text)] bg-[var(--surface)] border-b border-l border-[var(--border)] text-center">Language Reactor</div>
              <div className="p-4 font-bold text-[var(--text)] bg-[var(--surface)] border-b border-l border-[var(--border)] text-center">Trancy</div>
              ...
              {[
                ...
                <React.Fragment key={i}>
                  <div className={`p-4 text-[var(--text-dim)] ${i % 2 === 0 ? "bg-[var(--surface)]" : ""} border-b border-[var(--border)]`}>{row.feature}</div>
                  <div className={`p-4 text-center ${i % 2 === 0 ? "bg-[var(--surface)]" : ""} border-b border-l border-[var(--border)]`}>
          ...
          {/* Platform Support */}
          <h2 className="text-3xl font-bold text-[var(--text)]">Platform Support</h2>
          <p>One of the biggest practical differences between these two tools is which streaming services they support.</p>

          <p><strong className="text-[var(--text)]">Language Reactor</strong> focuses on Netflix and YouTube. That is it. If you primarily watch content on these two platforms, this is perfectly fine. But if you use Disney+, HBO Max, or Prime Video, you are out of luck.</p>

          <p><strong className="text-[var(--text)]">Trancy</strong> supports a wider range of platforms including Netflix, YouTube, Disney+, Coursera, TED, and several other video sites. This makes it more versatile if your content diet spans multiple services. However, neither tool supports Amazon Prime Video at the time of writing.</p>
          ...
          {/* Ease of Use */}
          <h2 className="text-3xl font-bold text-[var(--text)]">Ease of Use</h2>
          <p><strong className="text-[var(--text)]">Language Reactor</strong> has a mature, well-polished interface. When you open Netflix or YouTube, the extension automatically activates and displays dual subtitles below the video. The sidebar catalogue mode lets you browse content and filter by language and difficulty. The learning curve is gentle &mdash; most users figure it out within a few minutes.</p>

          <p><strong className="text-[var(--text)]">Trancy</strong> has a slightly busier interface with more options visible at once. The AI grammar panel opens alongside the subtitles, which can feel overwhelming at first. However, once you get used to the layout, it becomes intuitive. Trancy also includes an onboarding tutorial that walks new users through each feature. Trancy also includes AiTalk for AI conversation practice — read our full <a href="/blog/aitalk-review" className="text-[#C81FD4] hover:underline">AiTalk review</a>.</p>
          ...
          {/* Language Support */}
          <h2 className="text-3xl font-bold text-[var(--text)]">Language Support</h2>
          ...
          {/* Pros and Cons */}
          <h2 className="text-3xl font-bold text-[var(--text)]">Pros and Cons</h2>

          <div className="grid sm:grid-cols-2 gap-6 my-8">
            <div className="bg-[var(--surface)] rounded-xl p-6 border border-[var(--border)]">
              <h3 className="text-xl font-bold text-[var(--text)] mt-0 mb-4">Language Reactor</h3>
              <div className="mb-4">
            ...
            <div className="bg-[var(--surface)] rounded-xl p-6 border border-[var(--border)]">
              <h3 className="text-xl font-bold text-[var(--text)] mt-0 mb-4">Trancy</h3>
              <div className="mb-4">
                <h4 className="text-sm font-bold text-green-400 mb-2">Pros</h4>
                <ul className="space-y-1 list-none pl-0 m-0">
          ...
          {/* Verdict */}
          <h2 className="text-3xl font-bold text-[var(--text)]">Our Verdict</h2>
          <p><strong className="text-[var(--text)]">Choose Language Reactor if:</strong> You primarily use Netflix and YouTube, want a clean interface, prefer Anki integration for spaced repetition, and want a usable free tier. At $6/mo for Pro, it is also the cheaper option.</p>

          <p><strong className="text-[var(--text)]">Choose Trancy if:</strong> You want AI grammar analysis, use streaming platforms beyond Netflix and YouTube (especially Disney+), and value pronunciation audio and web page translation. The $8/mo price tag is justified if you actively use these features.</p>
          ...
          <h2 className="text-3xl font-bold text-[var(--text)]">The Free Alternative: Funlingo</h2>
          <div className="bg-[rgba(200,31,212,0.05)] rounded-xl p-8 border border-[#C81FD4]/20 my-8">
            <div className="flex items-center gap-2 mb-4">
              <Zap className="w-5 h-5 text-[#C81FD4]" />
              <span className="text-[#C81FD4] font-bold text-lg">Why pay when you do not have to?</span>
            </div>
            <p className="text-[var(--text-dim)] mb-4">Funlingo offers everything you need for language learning through video &mdash; completely free. Unlike Language Reactor and Trancy, you do not need to choose between a limited free tier and a monthly subscription.</p>
