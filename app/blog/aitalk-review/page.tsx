...
export const metadata: Metadata = {
  ...
  keywords: "aitalk, aitalk review, aitalk language learning, ai language practice tool, aitalk vs chatgpt, trancy aitalk, ai conversation practice, language learning ai tool 2026, funlingo vs aitalk, ai speaking practice, is aitalk worth it",
  alternates: { canonical: "/blog/aitalk-review" },
  openGraph: { title: "AiTalk Review (2026): Is It Worth $11.99/Month? Honest Test Results", description: "We tested AiTalk for several weeks. Honest review of features, pricing, and whether it's worth the $11.99/mo Trancy Pro price tag.", type: "article", url: "/blog/aitalk-review" },
};
